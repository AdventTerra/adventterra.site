...
<div className="pt-8 border-t border-white/10">
  ...
  <div className="relative w-full h-64 border border-[#C9A96E]/20 bg-[#1A1A1A]/40 overflow-hidden">
    ...
    <div className="absolute top-1/2 left-1/2 w-2 h-2 bg-[#C9A96E] rounded-full animate-pulse"
      style={{ animationDelay: "0.5s" }}
    />
    <div className="absolute top-1/3 right-1/4 w-2 h-2 bg-[#C9A96E] rounded-full animate-pulse"
